...
def main() -> int:
    ...
    operator_terms = [
        ...
        "CLI stop/restart must refuse active recording/finalization",
    ...
    checklist_terms = [
        ...
        "Run Playwright UI smoke",
        "dashboard, sessions, new-run, compare, Mac Helper, Ops, and Live screens",
    ...
    completion_audit_terms = [
        ...
        "bare Tailnet Helper addresses normalize to `http://<address>:5050`",
        ...
        "CLI Server Routes",
        "Playwright UI smoke",
        "desktop/mobile horizontal overflow and control-overlap checks",
